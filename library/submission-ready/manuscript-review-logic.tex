...
%% --- Logic review markup: blue insertions, red struck deletions ---
...
\ReviewAdd{For fixed $M\ne0$, if the same identity held for every real $p$, then every real $y$ could be written as $pM$ and $G(y)=(y/M)G(M)$, forcing $\R$-linearity.}
