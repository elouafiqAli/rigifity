...
%% --- Review markup: blue insertions, red struck deletions ---
...
regularity assumption on the function. \ReviewDel{That emphasis is ours;}\ReviewAdd{The emphasis is ours;} Kuczma's
...
shape is the tent\,---\,\ReviewDel{and the tent is not merely an example.
The tent is not an example chosen for convenience; it is forced, and its}\ReviewAdd{not a convenient example but a forced shape, whose}
...
derivations cited above \ReviewDel{spend it exactly there}\ReviewAdd{do so there}.
