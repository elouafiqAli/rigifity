...
- **X22 (★★★, Frugality).** Identify the minimal sub-collection of instances of $(\star_C)$ the proof actually consumes (the higher-dimensional analogue of Theorem 2's strict minimum).
