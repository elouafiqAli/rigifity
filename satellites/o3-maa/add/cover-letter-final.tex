...
identical\,---\,those hypotheses remain indispensable. The note
...
needed. The Monthly is the natural home for an expository note that
...
\begin{itemize}\setlength\itemsep{2pt}
  ...
  \item \textbf{Page count:} approximately 11 pages anonymous body,
        12 pages with title page.
  \item \textbf{Word count (approximate):} 4{,}200 words (TeX-counted body).
  ...
  \item \textbf{Use of generative AI:} Disclosed in the manuscript's
        Acknowledgments section. A proprietary neuro-symbolic AI research
        harness employing Claude Opus 3.7 and Lean 4 was used during initial
        exploratory theorem-discovery, and Claude Fable 5 was used for editorial
        review and formatting assistance. All results and presentation were
        analyzed and carried out by the author, who assumes full responsibility.
\end{itemize}
