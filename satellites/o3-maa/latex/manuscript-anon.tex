...
Theorem~\ref{thm:main} is folklore (cf.~\cite[\S2.1]{Aczel1966}). It
is \emph{not} a new mathematical result. The contribution of the
present paper is in three parts:
\begin{itemize}
...
(cf.~\cite[\S2.1]{Aczel1966}); the descriptive label is our convenience,
...
folkloric\,---\,Acz\'el's \cite[\S2.1]{Aczel1966} articulates the
...
functional equations (cf.~\cite[\S2.1]{Aczel1966}), and the present
paper grew out of
