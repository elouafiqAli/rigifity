...
equation tests~$G$), and survey three application areas\,---\,expected-utility
...
recur in derivations that produce the continuous-coefficient form as a
saturated identity.
\end{abstract}
...
The substitution technique behind Theorem~\ref{thm:main} is
folkloric\,---\,Acz\'el's \cite[\S2.1.4]{Aczel1966} contains the dyadic
precursor\,---\,and the continuous-coefficient regularity-free closure
is then a short step further. Why, then, does this paper exist?
