...
for each. Table~\ref{tab:dictionary} pairs five classical hypotheses
with the no-hypothesis row at the bottom: the first column names the
...
The endpoint substitution of Section~\ref{sec:proof} is folkloric\,---\,both
...
functional equations (cf.~\cite[\S2.1]{Aczel1966},
\cite[Ch.~13]{Kuczma2009}), and the present paper grew out of
...
During the preparation of this paper the author used a generative AI
assistant in two capacities: (\emph{i})~adversarial review of successive
drafts, with the model prompted in critical-reader mode to surface
defects in prose, argument structure, and prior-art positioning;
and (\emph{ii})~formatting assistance with \LaTeX{} mechanics and
bibliography construction. All mathematical content\,---\,statements,
proofs, and the structural analysis of Sections~\ref{sec:dictionary}
