...
\vspace{30px}
Ali Elouafiq, SQLI Digital, Rabat, Morocco, 
...
\small\itshape
Ali Elouafiq is Senior Systems Architect and Program Manager of the
SQLI Digital Lab in Hay Riad, Rabat, Morocco. His research interests
include counting and sampling, representation learning, and formal language and automata theory.
\end{minipage}
\end{center}
